...
INSERT INTO notice(title, content, sub_time, update_time) VALUES('세번째 공지사항', '세번째 공지사항의 내용입니다.', now(), now());


INSERT INTO member(email, password, name, address, phone_num, ticket_expire_date, role) VALUES('test1@test.com', '$2a$10$eqnT3Kk3F1oG7twaWyfGNukYuKu5nPhb.9CcXYtm3t.4mf1bUYgW6', '홍길동', '나성동', '010-1111-1111', '2024-08-08 10:00:00', 'ADMIN');
